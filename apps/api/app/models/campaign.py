...
class DailyCampaignUsage(Base):
    __tablename__ = "daily_campaign_usage"
    __table_args__ = (UniqueConstraint("user_id", "usage_date", name="uq_daily_campaign_usage"),)
    ...
    campaign_runs: Mapped[int] = mapped_column(default=0)
